...
public class SQLTransactionRepository implements ITransactionRepository {
    ...
    public int save(Transaction transaction) {
        ...
        KeyHolder keyHolder = new GeneratedKeyHolder(); // Just a place holder for TXNid that gets created by MySQl (AUTO_INCREMENT set to true)
        ...
        return  keyHolder.getKey().intValue();// return the transactionId received from DB
    }
